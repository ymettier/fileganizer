...
func TestPDFTextExtract(t *testing.T) {
	...
	t.Run("pdflatex per-character text", func(t *testing.T) {
		// Real-world PDF generated by pdfTeX which renders each character
		// individually via Tj+Td. Without font metric word gap detection,
		// the output would be "Loremipsumdolorsitamet".
		// Source: https://github.com/py-pdf/sample-files (CC-BY-SA-4.0)
		output, err := PDFTextExtract(context.Background(), "testdata/pdflatex-per-char-text.pdf")
		require.NoError(t, err)
